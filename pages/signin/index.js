...
export default function SignIn() {
  ...
  useEffect(() => {
    if (user) {
      setErrorText("Already Login! LogOut first");
      ...
      <main className="flex h-full items-center justify-center">
        <form onSubmit={handleSubmit(onSubmit)} className=" w-[450px] lg:w-[700px] p-3 bg-white rounded-lg shadow-xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            <button type="submit" disabled={loginDisabled} className="inline-block w-full py-2 bg-blue-600 text-white font-medium leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out disabled:bg-gray-400"
            >Login</button>
